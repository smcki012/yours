...
let createAppServer = require('datt/server/app').createAppServer
let createRendezvousServer = require('datt/server/rendezvous').createRendezvousServer
...
function set_build_worker_browserify () {
  ...
  build_worker_browserify
    ...
    .add(require.resolve('datt/core/worker.js'), {entry: true})
}
...
function set_build_core_browserify () {
  ...
  build_core_browserify
    ...
    .transform(envify)
    .transform(babelify, {presets: ['es2015', 'react'], sourceMaps: false})
    .require(require.resolve('datt/core/index.js'), {entry: true})
}
